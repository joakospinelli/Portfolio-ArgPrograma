...
export class SobreMiComponent implements OnInit {
  ...
  constructor(private service: InformacionService, private dialog: MatDialog, public auth: AuthService) { }
...
export class SobreMiCreate {
  ...
  constructor(private service: InformacionService, @Inject(MAT_DIALOG_DATA) private data: Informacion, public dialogRef: MatDialogRef<SobreMiCreate>){
    this.info = data;
  }
